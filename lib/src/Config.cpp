...
namespace s3benchmark {
    ...
    void Config::sanitize_client_config() {
        ...
        this->client_config.httpRequestTimeoutMs = REQUEST_TIMEOUT_MS;
        this->client_config.connectTimeoutMs = REQUEST_TIMEOUT_MS;
        this->client_config.requestTimeoutMs = REQUEST_TIMEOUT_MS;
